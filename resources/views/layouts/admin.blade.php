...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('backend/css/newsletter.css');?>">
    <link rel="stylesheet" href="<?php echo asset('js/vendor/redactor/redactor.css'); ?>">
    <link rel="stylesheet" href="<?php echo asset('backend/css/files.css'); ?>">
    ...
    <link rel='stylesheet' type='text/css' href="<?php echo asset('backend/plugins/datatables/dataTables.css');?>" />
    <link rel='stylesheet' type='text/css' href="<?php echo asset('backend/plugins/form-multiselect/css/multi-select.css');?>" />
    <script src="<?php echo asset('js/jquery.js');?>"></script>
    <link rel="stylesheet" href="<?php echo asset('backend/css/jquery.fileupload.css');?>">
...
<body flow-prevent-drop>
        ...
        <ul class="nav navbar-nav pull-right toolbar">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu userinfo arrow">
                    <li class="username">
                        <a href="#"><div class="pull-right"><h5>Bonjour, {{ Auth::user()->name }}!</h5></div></a>
                    </li>
                    <li class="userlinks">
    ...
    <script type="text/javascript" src="<?php echo asset('backend/js/bootstrap.min.js');?>"></script>
    ...
    <script type="text/javascript" src="<?php echo asset('backend/js/fieldChooser.js');?>"></script>
    ...
    @if(isset($isFileManager))
        <script type="text/javascript" src="<?php echo asset('backend/js/files.js');?>"></script>
        <script type="text/javascript" src="<?php echo asset('backend/js/upload/upload.js');?>"></script>
        <script src="//blueimp.github.io/JavaScript-Load-Image/js/load-image.all.min.js"></script>
        <script src="//blueimp.github.io/JavaScript-Canvas-to-Blob/js/canvas-to-blob.min.js"></script>
        <script src="<?php echo asset('backend/js/upload/jquery.iframe-transport.js');?>"></script>
        <script src="<?php echo asset('backend/js/upload/jquery.fileupload.js');?>"></script>
        <script src="<?php echo asset('backend/js/upload/jquery.fileupload-process.js');?>"></script>
        <script src="<?php echo asset('backend/js/upload/jquery.fileupload-image.js');?>"></script>
        <script src="<?php echo asset('backend/js/upload/jquery.fileupload-validate.js');?>"></script>
    @endif
