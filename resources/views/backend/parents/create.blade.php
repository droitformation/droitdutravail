...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-midnightblue">
            ...
            <!-- form start -->
            <form action="{!!  url('admin/parent')!!}" enctype="multipart/form-data" method="POST" class="validate-form form-horizontal" data-validate="parsley">{!! csrf_field() !!}
                <div class="panel-heading">
                    <h4>Ajouter une catégorie parente</h4>
                </div>
